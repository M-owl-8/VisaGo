...
CREATE TABLE "Application" (
    ...
    CONSTRAINT "Application_visaTypeId_fkey" FOREIGN KEY ("visaTypeId") REFERENCES "VisaType" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE INDEX "Application_countryId_idx" ON "Application"("countryId");

-- CreateIndex
CREATE INDEX "Application_visaTypeId_idx" ON "Application"("visaTypeId");
