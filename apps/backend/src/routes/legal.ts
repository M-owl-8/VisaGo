      ...
      sections: [
        {
          ...
          content:
            'Account Information: Email, name, phone number, password. Visa Application Data: Nationality, visa type, dates, status. Documents: Passport scans, photos, supporting documents. Payment Information: Transaction records. Device Information: Device type, OS version, app version. Usage Data: Features used, time spent, error logs.',
        },
        {
          title: '2. How We Use Information',
          content:
            'Provide visa application services and guidance. Process payments securely. Communicate about your applications. Improve app features. Comply with legal obligations.',
        },
        {
          title: '3. Data Security',
          content:
            'We store data on secure servers with encryption. Payment details are never stored by VisaBuddy.',
        },
        {
    ...
    res.json({
      ...
      sections: [
        ...
        },
        {
          ...
          content:
            'VisaBuddy provides information and tools to help manage visa applications. We are NOT immigration lawyers.',
        },
        {
          title: '3. User Responsibilities',
          content:
            'Provide accurate information. Not share account credentials. Not upload fraudulent documents. Comply with applicable laws.',
        },
        {
          title: '4. Limitations',
