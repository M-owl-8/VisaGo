...
router.get(
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const template = await FormFillingService.getFormTemplate(
        countryId,
        visaTypeId
      );
...
router.post(
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const preFilledForm = await FormFillingService.preFillForm(
        req.userId,
        countryId,
        visaTypeId
      );
...
router.get(
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const result = await FormSubmissionService.downloadFormPDF(
        applicationId,
        req.userId
      );
