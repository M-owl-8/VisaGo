...
type CountryCode = 'US' | 'GB' | 'CA' | 'AU' | 'DE' | 'ES' | 'JP' | 'AE' | 'FR' | 'KR';
// Allow any visa type; we normalize to category buckets for generic coverage
type VisaType = string;

const FALLBACK_CHECKLISTS: Record<
  CountryCode,
  Record<'student' | 'tourist', FallbackChecklistItem[]>
> = {
  US: {
    student: [
      {
...
// Generic fallbacks for any country / any visa type (normalized to category buckets)
const GENERIC_FALLBACKS: Record<
  'student' | 'tourist' | 'work' | 'business' | 'family' | 'transit',
  ...
  student: [
    {
      ...
      nameRu: 'Действительный Паспорт',
      category: 'required',
      description: 'Passport valid at least 6 months after planned return date.',
      descriptionUz: 'Rejalashtirilgan qaytish sanasidan keyin kamida 6 oy amal qiladigan pasport.',
      descriptionRu: 'Паспорт действителен не менее 6 месяцев после планируемой даты возвращения.',
      required: true,
      priority: 'high',
      whereToObtain: 'Apply at local migration or internal affairs office.',
      whereToObtainUz: "Mahalliy migratsiya yoki ichki ishlar bo'limida murojaat qiling.",
      whereToObtainRu: 'Обратитесь в местную миграционную службу или органы внутренних дел.',
    },
    {
      document: 'passport_photo',
      name: 'Passport Photo',
      ...
      nameRu: 'Фото на Паспорт',
      category: 'required',
      description: 'Recent biometric photo meeting destination specs.',
      descriptionUz: 'Manzil talablariga mos yangilangan biometrik foto.',
      descriptionRu: 'Недавнее биометрическое фото, соответствующее требованиям страны назначения.',
      required: true,
      priority: 'high',
      whereToObtain: 'Take at a photo studio.',
    ...
    },
    {
      ...
      nameUz: 'Ariza Formasi',
      nameRu: 'Анкета на Визу',
      category: 'required',
      description: 'Completed visa application form or online confirmation.',
      descriptionUz: "To'ldirilgan viza arizasi yoki onlayn tasdiq.",
      descriptionRu: 'Заполненная анкета на визу или онлайн-подтверждение.',
      required: true,
      priority: 'high',
      whereToObtain: 'Download or complete online, then print confirmation if needed.',
      whereToObtainUz: 'Onlayn to‘ldiring yoki yuklab oling va tasdiqni chop eting.',
      whereToObtainRu:
        'Заполните онлайн или скачайте, при необходимости распечатайте подтверждение.',
    },
    {
      document: 'university_acceptance',
      name: 'Admission / Acceptance',
      nameUz: 'Qabul Hujjati',
      nameRu: 'Письмо о Зачислении',
      category: 'required',
      description: 'Official admission/acceptance letter or enrollment confirmation.',
      descriptionUz: 'Rasmiy qabul xati yoki o‘qishga qabul qilinganlik tasdig‘i.',
      descriptionRu: 'Официальное письмо о зачислении или подтверждение поступления.',
      required: true,
      priority: 'high',
      whereToObtain: 'Request from the school/university.',
      whereToObtainUz: 'Maktab/universitetdan so‘rang.',
      whereToObtainRu: 'Запросите в учебном заведении.',
    },
    {
      document: 'financial_proof',
      name: 'Financial Proof',
      nameUz: 'Moliyaviy Dalillar',
      nameRu: 'Финансовые Доказательства',
      category: 'required',
      description: 'Bank statements/scholarship/sponsor proof covering tuition and living costs.',
      descriptionUz:
        "O'qish va yashash xarajatlarini qoplaydigan bank hisoblari yoki homiy hujjatlari.",
      descriptionRu:
        'Банковские выписки/стипендия/документы спонсора, покрывающие учебу и проживание.',
      required: true,
      priority: 'high',
      whereToObtain: 'Collect recent bank statements or official sponsor letters.',
      whereToObtainUz: 'So‘nggi bank hisoblari yoki homiylik xatlarini to‘plang.',
      whereToObtainRu: 'Соберите свежие банковские выписки или письма спонсора.',
    },
    {
      document: 'tuition_payment_plan',
      name: 'Tuition Payment / Plan',
      nameUz: "O'qish To'lovi Rejasi",
      nameRu: 'Оплата/План Оплаты Обучения',
      category: 'highly_recommended',
      description: 'Proof of paid tuition, deposit, or payment plan if applicable.',
      descriptionUz: "To'langan o‘qish to‘lovi, depozit yoki to‘lov rejasi bo‘yicha tasdiq.",
      descriptionRu: 'Подтверждение оплаты, депозита или плана платежей за обучение.',
      required: false,
      priority: 'high',
      whereToObtain: 'From school finance office or bank receipts.',
      whereToObtainUz: 'Maktab moliya bo‘limi yoki bank kvitansiyalaridan oling.',
      whereToObtainRu: 'Из финансового отдела школы или банковских квитанций.',
    },
    {
      document: 'accommodation_proof',
      name: 'Accommodation Proof',
      nameUz: 'Turarjoy Tasdig‘i',
      nameRu: 'Подтверждение Проживания',
      category: 'highly_recommended',
      description: 'Dorm reservation, rental, or host invitation.',
      descriptionUz: 'Yotoqxona bandi, ijara yoki mezbon taklifi.',
      descriptionRu: 'Бронь общежития, аренда или приглашение принимающей стороны.',
      required: false,
      priority: 'medium',
      whereToObtain: 'Provide booking, lease draft, or invitation letter.',
      whereToObtainUz: 'Bron, ijara shartnomasi yoki taklif xatini taqdim eting.',
      whereToObtainRu: 'Предоставьте бронь, проект аренды или письмо-приглашение.',
    },
    {
      document: 'travel_insurance',
      name: 'Travel / Medical Insurance',
      nameUz: 'Sayohat / Tibbiy Sug‘urta',
      nameRu: 'Путешеств./Мед. Страховка',
      category: 'highly_recommended',
      description: 'Insurance covering the full stay (medical + repatriation where required).',
      descriptionUz: 'Butun safar davrini qamrab oluvchi (tibbiy va repatriatsiya) sug‘urta.',
      descriptionRu: 'Страховка, покрывающая весь период поездки (медицинская + репатриация).',
      required: false,
      priority: 'medium',
      whereToObtain: 'Purchase from local insurers or approved providers.',
      whereToObtainUz: 'Mahalliy sug‘urta kompaniyalaridan sotib oling.',
      whereToObtainRu: 'Купите у местных страховых компаний или одобренных провайдеров.',
    },
    {
      document: 'ties_supporting_docs',
      name: 'Ties / Return Intent',
      nameUz: 'Bog‘liqlik / Qaytish Niyati',
      nameRu: 'Связи / Намерение Вернуться',
      category: 'optional',
      description: 'Employment/study letters, property docs, family ties to show return intent.',
      descriptionUz:
        'Ish/o‘qish xatlari, mulk hujjatlari, oila bog‘liqligi qaytish niyatini ko‘rsatadi.',
      descriptionRu:
        'Письма с работы/учёбы, документы на имущество, семейные связи для подтверждения намерения вернуться.',
      required: false,
      priority: 'low',
      whereToObtain: 'Gather from employer, school, cadastre, or family documents.',
      whereToObtainUz: 'Ish beruvchi, o‘quv yurti, kadastr yoki oila hujjatlaridan oling.',
      whereToObtainRu:
        'Получите у работодателя, учебного заведения, кадастра или из семейных документов.',
    },
  ],
  tourist: [
    {
    ...
    },
    {
      ...
      nameRu: 'Маршрут Поездки',
      category: 'highly_recommended',
      description: 'Planned itinerary or draft bookings (flights/trains).',
      descriptionUz: "Rejalashtirilgan yo'nalish yoki chiptalar bo‘yicha dastlabki bronlar.",
      descriptionRu: 'Планируемый маршрут или черновые бронирования рейсов/поездов.',
      required: false,
      priority: 'medium',
      whereToObtain: 'Create draft bookings or itinerary outline.',
      whereToObtainUz: 'Dastlabki bronlar yoki yo‘nalish rejasini tuzing.',
      whereToObtainRu: 'Сделайте черновые брони или план маршрута.',
    },
    {
      document: 'accommodation_proof',
      name: 'Accommodation Proof',
      ...
      nameRu: 'Подтверждение Проживания',
      category: 'highly_recommended',
      description: 'Hotel booking, rental draft, or host invitation.',
      descriptionUz: 'Mehmonxona bron qilish, ijara shartnomasi yoki mezbon taklifi.',
      descriptionRu: 'Бронь отеля, проект аренды или приглашение принимающей стороны.',
      required: false,
      priority: 'medium',
      whereToObtain: 'Provide booking, lease draft, or invitation letter.',
      whereToObtainUz: 'Bron, ijara shartnomasi yoki taklif xatini taqdim eting.',
    ...
    },
    {
      ...
      nameRu: 'Финансовые Доказательства',
      category: 'required',
      description: 'Recent bank statements or sponsor proof showing trip funds.',
      descriptionUz: 'So‘nggi bank hisoblari yoki homiy hujjatlari safar xarajatlarini ko‘rsatadi.',
      descriptionRu:
        'Свежие банковские выписки или документы спонсора, подтверждающие финансирование поездки.',
      required: true,
      priority: 'high',
      whereToObtain: 'Collect recent statements or sponsor letters.',
      whereToObtainUz: 'So‘nggi hisoblar yoki homiylik xatlarini to‘plang.',
      whereToObtainRu: 'Соберите выписки или письма спонсора.',
    },
    {
      document: 'employment_or_study_proof',
      name: 'Employment/Study Proof',
      nameUz: 'Ish/O‘qish Tasdig‘i',
      nameRu: 'Справка о Работе/Учёбе',
      category: 'highly_recommended',
      description: 'Employment letter or study confirmation to show ties and purpose.',
      descriptionUz: 'Ish xati yoki o‘qish tasdig‘i maqsad va bog‘liqlikni ko‘rsatadi.',
      descriptionRu: 'Письмо с работы или подтверждение учёбы для демонстрации целей и связей.',
      required: false,
      priority: 'medium',
      whereToObtain: 'Request from employer or school.',
      whereToObtainUz: 'Ish beruvchi yoki o‘quv yurtidan oling.',
      whereToObtainRu: 'Запросите у работодателя или учебного заведения.',
    },
    {
      document: 'travel_insurance',
      name: 'Travel Insurance',
      nameUz: 'Sayohat Sug‘urtasi',
      nameRu: 'Страховка для Поездки',
      category: 'highly_recommended',
      description: 'Travel/medical insurance covering full stay and emergencies.',
      descriptionUz: 'Butun safarni va favqulodda holatlarni qamrab oluvchi sug‘urta.',
      descriptionRu: 'Страховка, покрывающая всю поездку и ЧП.',
      required: false,
      priority: 'medium',
      whereToObtain: 'Purchase from insurers or travel agencies.',
      whereToObtainUz: 'Sug‘urta kompaniyasi yoki sayohat agentligidan xarid qiling.',
      whereToObtainRu: 'Купите у страховщика или в турфирме.',
    },
    {
      document: 'ties_supporting_docs',
      name: 'Ties / Return Intent',
      ...
      nameRu: 'Связи / Намерение Вернуться',
      category: 'optional',
      description: 'Property, family ties, or employment evidence to show return intent.',
      descriptionUz: 'Mulk, oila yoki ishga oid dalillar qaytish niyatini ko‘rsatadi.',
      descriptionRu: 'Имущество, семейные связи или работа для подтверждения намерения вернуться.',
      required: false,
      priority: 'low',
      whereToObtain: 'Provide property docs, family records, or employer letters.',
      whereToObtainUz: 'Mulk hujjatlari, oila hujjatlari yoki ish xatini taqdim eting.',
      whereToObtainRu:
        'Предоставьте документы на имущество, семейные записи или письмо работодателя.',
    },
  ],
  work: [
    {
      ...
      nameRu: 'Действительный Паспорт',
      category: 'required',
      description: 'Passport valid at least 6 months after planned return.',
      descriptionUz: 'Rejalashtirilgan qaytish sanasidan keyin kamida 6 oy amal qiladigan pasport.',
      descriptionRu: 'Паспорт действителен не менее 6 месяцев после планируемой даты возвращения.',
      required: true,
      priority: 'high',
    ...
    },
    {
      ...
      nameUz: 'Mehnat Shartnomasi / Taklif',
      nameRu: 'Трудовой Договор / Оффер',
      category: 'required',
      description: 'Signed job offer or contract specifying role, salary, and duration.',
      descriptionUz:
        'Lavozim, maosh va muddat ko‘rsatilgan imzolangan ish taklifi yoki shartnomasi.',
      descriptionRu: 'Подписанный оффер или договор с указанием должности, зарплаты и срока.',
      required: true,
      priority: 'high',
      whereToObtain: 'Request from employer.',
      whereToObtainUz: 'Ish beruvchidan oling.',
      whereToObtainRu: 'Запросите у работодателя.',
    },
    {
      document: 'work_permit_sponsorship',
      name: 'Work Permit / Sponsorship',
      nameUz: 'Ish Ruxsati / Homiylik',
      nameRu: 'Разрешение на Работу / Спонсорство',
      category: 'required',
      description: 'Work permit or employer sponsorship approval (if applicable).',
      descriptionUz: 'Ish ruxsati yoki ish beruvchi homiylik tasdig‘i (agar kerak bo‘lsa).',
      descriptionRu:
        'Разрешение на работу или подтверждение спонсорства работодателя (если требуется).',
      required: true,
      priority: 'high',
      whereToObtain: 'Provided by employer or relevant authority.',
      whereToObtainUz: 'Ish beruvchi yoki tegishli idora beradi.',
      whereToObtainRu: 'Предоставляется работодателем или уполномоченным органом.',
    },
    {
      document: 'financial_proof',
      name: 'Financial Proof',
      ...
      nameRu: 'Финансовые Доказательства',
      category: 'required',
      description: 'Recent bank statements or sponsor proof showing sufficient funds.',
      descriptionUz: 'So‘nggi bank hisoblari yoki homiy hujjatlari yetarli mablag‘ni ko‘rsatadi.',
      descriptionRu:
        'Свежие банковские выписки или документы спонсора, подтверждающие достаточные средства.',
      required: true,
      priority: 'high',
      whereToObtain: 'Collect recent statements or sponsor letters.',
      whereToObtainUz: 'So‘nggi hisoblar yoki homiylik xatlarini to‘plang.',
    ...
    },
    {
      ...
      nameRu: 'Путешеств./Мед. Страховка',
      category: 'highly_recommended',
      description: 'Insurance covering stay, medical emergencies, and repatriation if required.',
      descriptionUz:
        'Safar, tibbiy favqulodda holatlar va zarur bo‘lsa repatriatsiyani qamrab oluvchi sug‘urta.',
      descriptionRu: 'Страховка, покрывающая пребывание, мед. ЧП и репатриацию при необходимости.',
      required: false,
      priority: 'medium',
      whereToObtain: 'Purchase from local insurers or approved providers.',
      whereToObtainUz: 'Mahalliy sug‘urta kompaniyalaridan sotib oling.',
    ...
    },
    {
      ...
      nameRu: 'Подтверждение Проживания',
      category: 'highly_recommended',
      description: 'Rental, employer-provided housing, or temporary booking.',
      descriptionUz: 'Ijara, ish beruvchi taqdim etgan uy-joy yoki vaqtinchalik bron.',
      descriptionRu: 'Аренда, жилье от работодателя или временная бронь.',
      required: false,
      priority: 'medium',
      whereToObtain: 'Provide lease, housing letter, or booking.',
      whereToObtainUz: 'Ijara shartnomasi, uy-joy xati yoki bronni taqdim eting.',
      whereToObtainRu: 'Предоставьте договор аренды, письмо о жилье или бронь.',
    },
    {
      document: 'ties_supporting_docs',
      name: 'Ties / Return Intent',
      ...
      nameRu: 'Связи / Намерение Вернуться',
      category: 'optional',
      description: 'Property, family ties, or prior employment to show intent to return.',
      descriptionUz: 'Mulk, oila bog‘liqligi yoki avvalgi ish joyi qaytish niyatini ko‘rsatadi.',
      descriptionRu:
        'Имущество, семейные связи или предыдущая работа для демонстрации намерения вернуться.',
      required: false,
      priority: 'low',
      whereToObtain: 'Provide property docs, family records, or prior employer letters.',
      whereToObtainUz: 'Mulk hujjatlari, oila hujjatlari yoki avvalgi ish beruvchi xatini bering.',
      whereToObtainRu:
        'Предоставьте документы на имущество, семейные записи или письмо прежнего работодателя.',
    },
  ],
  business: [
    {
    ...
    {
      document: 'business_invitation',
      name: 'Business Invitation / Event Letter',
      nameUz: 'Biznes Taklifnoma / Tadbir Xati',
      nameRu: 'Бизнес-приглашение / Письмо о Мероприятии',
      category: 'required',
      description:
        'Official invitation from partner, conference, or organizer detailing purpose/dates.',
      descriptionUz:
        'Hamkor, konferensiya yoki tashkilotchidan maqsad/sanalarni ko‘rsatuvchi rasmiy taklif.',
      descriptionRu:
        'Официальное приглашение от партнера, конференции или организатора с указанием цели/дат.',
      required: true,
      priority: 'high',
      whereToObtain: 'Request from inviting company or event organizer.',
      whereToObtainUz: 'Takliflovchi kompaniya yoki tadbir tashkilotchisidan so‘rang.',
      whereToObtainRu: 'Запросите у приглашающей компании или организатора мероприятия.',
    },
    {
      document: 'company_cover_letter',
      name: 'Company Cover Letter',
      nameUz: 'Kompaniya Xati',
      nameRu: 'Письмо Компании',
      category: 'highly_recommended',
      description: 'Letter from employer explaining trip purpose, dates, and who pays.',
      descriptionUz: 'Ish beruvchidan safar maqsadi, sanalari va to‘lovchilar haqida xat.',
      descriptionRu: 'Письмо от работодателя с указанием цели поездки, дат и плательщика.',
      required: false,
      priority: 'medium',
      whereToObtain: 'Request from employer HR/management.',
      whereToObtainUz: 'Ish beruvchi HR/boshqaruvdan so‘rang.',
      whereToObtainRu: 'Запросите в HR/руководстве работодателя.',
    },
    {
      document: 'financial_proof',
      name: 'Financial Proof',
      ...
      nameRu: 'Финансовые Доказательства',
      category: 'required',
      description: 'Bank statements or company funding proof for the trip.',
      descriptionUz: 'Safar uchun bank hisoblari yoki kompaniya tomonidan moliyalashtirish dalili.',
      descriptionRu: 'Банковские выписки или подтверждение финансирования поездки компанией.',
      required: true,
      priority: 'high',
      whereToObtain: 'Collect recent statements or employer funding letter.',
      whereToObtainUz: 'So‘nggi hisoblar yoki ish beruvchidan moliyalashtirish xatini oling.',
      whereToObtainRu: 'Соберите выписки или письмо о финансировании от работодателя.',
    },
    {
      document: 'accommodation_proof',
      name: 'Accommodation Proof',
      ...
      nameRu: 'Подтверждение Проживания',
      category: 'highly_recommended',
      description: 'Hotel booking or host invitation for business stay.',
      descriptionUz: 'Biznes tashrifi uchun mehmonxona bron yoki mezbon taklifi.',
      descriptionRu: 'Бронь отеля или приглашение принимающей стороны для деловой поездки.',
      required: false,
      priority: 'medium',
      whereToObtain: 'Provide booking or invitation.',
      whereToObtainUz: 'Bron yoki taklifni taqdim eting.',
      whereToObtainRu: 'Предоставьте бронь или приглашение.',
    },
    {
      document: 'travel_insurance',
      name: 'Travel / Medical Insurance',
      ...
      nameRu: 'Путешеств./Мед. Страховка',
      category: 'highly_recommended',
      description: 'Insurance covering business trip duration and emergencies.',
      descriptionUz: 'Biznes safar muddatini va favqulodda holatlarni qamrab oluvchi sug‘urta.',
      descriptionRu: 'Страховка, покрывающая срок деловой поездки и ЧП.',
      required: false,
      priority: 'medium',
      whereToObtain: 'Purchase from insurers or travel agencies.',
      whereToObtainUz: 'Sug‘urta kompaniyasi yoki sayohat agentligidan xarid qiling.',
    ...
    },
    {
      ...
      nameRu: 'Связи / Намерение Вернуться',
      category: 'optional',
      description: 'Evidence of ongoing employment, property, or family to show return intent.',
      descriptionUz: 'Davom etayotgan ish, mulk yoki oila bog‘liqligi qaytish niyatini ko‘rsatadi.',
      descriptionRu:
        'Действующая работа, имущество или семья для подтверждения намерения вернуться.',
      required: false,
      priority: 'low',
      whereToObtain: 'Provide employer letters, property docs, or family records.',
      whereToObtainUz: 'Ish beruvchi xatlari, mulk hujjatlari yoki oila hujjatlarini bering.',
      whereToObtainRu:
        'Предоставьте письма работодателя, документы на имущество или семейные записи.',
    },
  ],
  family: [
    {
    ...
    {
      document: 'invitation_letter',
      name: 'Invitation Letter (Family/Friend)',
      nameUz: 'Taklifnoma (Oila/Do‘st)',
      nameRu: 'Приглашение (Семья/Друг)',
      category: 'required',
      description: 'Invitation from host stating relationship, stay dates, and address.',
      descriptionUz: 'Mezbonning munosabat, qolish sanalari va manzilni ko‘rsatuvchi taklifnomasi.',
      descriptionRu:
        'Приглашение от принимающей стороны с указанием отношений, дат пребывания и адреса.',
      required: true,
      priority: 'high',
      whereToObtain: 'Request from family member/friend abroad.',
      whereToObtainUz: 'Chet eldagi oila a’zosi/do‘stdan so‘rang.',
      whereToObtainRu: 'Запросите у члена семьи/друга за рубежом.',
    },
    {
      document: 'relationship_proof',
      name: 'Relationship Proof',
      nameUz: 'Munosabatni Tasdiqlash',
      nameRu: 'Подтверждение Родства',
      category: 'highly_recommended',
      description: 'Birth/marriage certificates or other documents proving relationship.',
      descriptionUz:
        'Tug‘ilish/nikoh guvohnomalari yoki munosabatni tasdiqlovchi boshqa hujjatlar.',
      descriptionRu: 'Свидетельства о рождении/браке или другие документы, подтверждающие родство.',
      required: false,
      priority: 'medium',
      whereToObtain: 'Provide official civil registry documents.',
      whereToObtainUz: 'Fuqarolik holati dalolatnomalari bo‘limidan oling.',
      whereToObtainRu: 'Получите в органах ЗАГС.',
    },
    {
      document: 'financial_proof',
      name: 'Financial Proof (Host or Self)',
      nameUz: 'Moliyaviy Dalillar (Mezbon yoki O‘zi)',
      nameRu: 'Финансовые Доказательства (Принимающий или Сам)',
      category: 'required',
      description:
        'Bank statements showing ability to cover stay; if host-sponsored, add host finances.',
      descriptionUz:
        'Qolishni qoplay olishini ko‘rsatuvchi bank hisoblari; agar mezbon homiy bo‘lsa, uning moliyasi.',
      descriptionRu:
        'Банковские выписки, подтверждающие финансирование; если спонсор — принимающий, приложите его финансы.',
      required: true,
      priority: 'high',
      whereToObtain: 'Collect statements; if sponsored, add host’s financial docs.',
      whereToObtainUz: 'Hisoblarni to‘plang; homiy bo‘lsa, mezbon moliya hujjatlarini qo‘shing.',
      whereToObtainRu: 'Соберите выписки; при спонсорстве добавьте финансы принимающего.',
    },
    {
      document: 'accommodation_proof',
      name: 'Accommodation Proof',
      ...
      nameRu: 'Подтверждение Проживания',
      category: 'highly_recommended',
      description: 'Host letter with address or hotel booking if not staying with host.',
      descriptionUz: 'Mezbon xati (manzil bilan) yoki mezbonda qolmasangiz mehmonxona broni.',
      descriptionRu:
        'Письмо принимающего с адресом или бронь отеля, если не у принимающей стороны.',
      required: false,
      priority: 'medium',
      whereToObtain: 'Provide host letter or booking.',
      whereToObtainUz: 'Mezbon xati yoki bronni taqdim eting.',
      whereToObtainRu: 'Предоставьте письмо принимающего или бронь.',
    },
    {
      document: 'travel_insurance',
      name: 'Travel / Medical Insurance',
      ...
      nameRu: 'Путешеств./Мед. Страховка',
      category: 'highly_recommended',
      description: 'Insurance covering stay duration and emergencies.',
      descriptionUz: 'Qolish davri va favqulodda holatlarni qamrab oluvchi sug‘urta.',
      descriptionRu: 'Страховка, покрывающая срок пребывания и ЧП.',
      required: false,
      priority: 'medium',
      whereToObtain: 'Purchase from insurers or travel agencies.',
      whereToObtainUz: 'Sug‘urta kompaniyasi yoki sayohat agentligidan xarid qiling.',
    ...
    },
    {
      document: 'ties_supporting_docs',
      name: 'Return Intent',
      nameUz: 'Qaytish Niyati',
      nameRu: 'Намерение Вернуться',
      category: 'optional',
      description: 'Property, employment, or family ties to show return intent.',
      descriptionUz: 'Mulk, ish yoki oila bog‘liqligi qaytish niyatini ko‘rsatadi.',
      descriptionRu: 'Имущество, работа или семейные связи для подтверждения намерения вернуться.',
      required: false,
      priority: 'low',
      whereToObtain: 'Provide property docs, employer letters, or family records.',
      whereToObtainUz: 'Mulk hujjatlari, ish xati yoki oila hujjatlarini taqdim eting.',
      whereToObtainRu:
        'Предоставьте документы на имущество, письмо работодателя или семейные записи.',
    },
  ],
  transit: [
    {
      ...
      nameRu: 'Действительный Паспорт',
      category: 'required',
      description: 'Passport valid beyond transit and onward travel.',
      descriptionUz: 'Tranzit va keyingi safar uchun amal qiladigan pasport.',
      descriptionRu: 'Паспорт, действительный на время транзита и дальнейшей поездки.',
      required: true,
      priority: 'high',
      whereToObtain: 'Apply at local migration or internal affairs office.',
      whereToObtainUz: "Mahalliy migratsiya yoki ichki ishlar bo'limida murojaat qiling.",
    ...
    {
      document: 'visa_application_form',
      name: 'Application Form (Transit)',
      nameUz: 'Ariza Formasi (Tranzit)',
      nameRu: 'Анкета (Транзит)',
      category: 'required',
      description: 'Transit visa application form or online confirmation, if required.',
      descriptionUz: 'Tranzit viza arizasi yoki onlayn tasdiq (talab qilinganda).',
      descriptionRu: 'Анкета на транзитную визу или онлайн-подтверждение, если требуется.',
      required: true,
      priority: 'high',
      whereToObtain: 'Download or complete online; confirm transit requirements first.',
      whereToObtainUz:
        'Onlayn to‘ldiring yoki yuklab oling; tranzit talablari bor-yo‘qligini tekshiring.',
      whereToObtainRu: 'Заполните онлайн или скачайте; проверьте необходимость транзитной визы.',
    },
    {
      document: 'onward_ticket',
      name: 'Onward / Return Ticket',
      nameUz: 'Keyingi / Qaytish Chipta',
      nameRu: 'Билет Далее / Обратно',
      category: 'required',
      description: 'Confirmed onward ticket matching transit plan.',
      descriptionUz: 'Tranzit rejasiga mos tasdiqlangan keyingi chipta.',
      descriptionRu: 'Подтвержденный билет согласно плану транзита.',
      required: true,
      priority: 'high',
      whereToObtain: 'Provide confirmed booking.',
      whereToObtainUz: 'Tasdiqlangan bronni taqdim eting.',
      whereToObtainRu: 'Предоставьте подтвержденную бронь.',
    },
    {
      document: 'final_destination_visa',
      name: 'Final Destination Visa (if required)',
      nameUz: 'Oxirgi Manzil Vizasi (talab qilinsa)',
      nameRu: 'Виза В Страну Назначения (если требуется)',
      category: 'required',
      description: 'Visa for final destination if that country requires one.',
      descriptionUz: 'Oxirgi manzil davlati talab qilsa, u yerga viza.',
      descriptionRu: 'Виза в конечную страну, если требуется.',
      required: true,
      priority: 'high',
      whereToObtain: 'Obtain from destination country’s embassy/consulate.',
      whereToObtainUz: 'Manzil davlat elchixonasi/konsulligidan oling.',
      whereToObtainRu: 'Получите в посольстве/консульстве страны назначения.',
    },
    {
      document: 'financial_proof',
      name: 'Financial Proof',
      ...
      nameRu: 'Финансовые Доказательства',
      category: 'highly_recommended',
      description: 'Proof of funds for transit and onward travel.',
      descriptionUz: 'Tranzit va keyingi safar uchun mablag‘ dalillari.',
      descriptionRu: 'Доказательство средств на транзит и дальнейшую поездку.',
      required: false,
      priority: 'medium',
      whereToObtain: 'Provide recent bank statements.',
      whereToObtainUz: 'So‘nggi bank hisoblarini taqdim eting.',
      whereToObtainRu: 'Предоставьте свежие банковские выписки.',
    },
    {
      document: 'travel_insurance',
      name: 'Travel / Medical Insurance',
      ...
      nameRu: 'Путешеств./Мед. Страховка',
      category: 'highly_recommended',
      description: 'Insurance covering transit period and emergencies.',
      descriptionUz: 'Tranzit davri va favqulodda holatlarni qamrab oluvchi sug‘urta.',
      descriptionRu: 'Страховка на период транзита и ЧП.',
      required: false,
      priority: 'medium',
      whereToObtain: 'Purchase from insurers or travel agencies.',
      whereToObtainUz: 'Sug‘urta kompaniyasi yoki sayohat agentligidan xarid qiling.',
...
export function getFallbackChecklist(
  ...
  const normalizedVisaType: 'student' | 'tourist' | 'work' | 'business' | 'family' | 'transit' =
    vt.includes('student')
      ? 'student'
      : vt.includes('work') || vt.includes('skilled') || vt.includes('employment')
        ? 'work'
        : vt.includes('business') || vt.includes('conference') || vt.includes('trade')
          ? 'business'
          : vt.includes('family') ||
              vt.includes('spouse') ||
              vt.includes('reunion') ||
  ...
  const checklist =
    FALLBACK_CHECKLISTS[code]?.[
      normalizedVisaType === 'student' || normalizedVisaType === 'tourist'
        ? normalizedVisaType
        : ('tourist' as 'student' | 'tourist')
    ];

  if (!checklist || checklist.length === 0) {
    // Return generic fallback for any country/visaType
    return GENERIC_FALLBACKS[normalizedVisaType] || [];
  }
