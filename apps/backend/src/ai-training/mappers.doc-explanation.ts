/**
 * Document Explanation Training Data Mapper
 * Maps AIInteraction records to TrainingExample for document explanation
 */
...
export function mapDocExplanationInteractionToTrainingExample(
  ...
  try {
    ...
    // Build output (the document explanation)
    ...
    console.error('[Mapper] Failed to map doc explanation interaction', {
