...
export default function VisaOverviewScreen({
  ...
  const handleCreateApplication = async () => {
    ...
    try {
      ...
      // Create visa application (FREE - no payment required)
      ...
      // Navigate directly to home (no payment needed)
      Alert.alert(
        'Success!',
        'Your application has been created. Start uploading documents!',
        [
          {
            text: 'OK',
